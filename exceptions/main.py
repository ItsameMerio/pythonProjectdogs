...
from dogexceptions import ObjectIsNotDogObjectError, FeedingDogError
...
def add_dog(herd, dog):
    ...
    ObjectIsNotDogObjectError, print its error message
    '''
    try:
        herd.add_member(dog)
...
def feed_dog(dog, food):
    ...
    FeedingDogError, print its error message
    '''
...
def main():
    ...
    i.e. different subclass of FeedingDogError.
    '''

    #dog1.feed("carrot")                     # This one should cause a suitable FeedingDogError
    #dog2.feed(cookies)                      # This one should cause a suitable FeedingDogError
    #dog3.feed(sausages)                     # This one should cause a suitable FeedingDogError
